...
import { fetchClaimById, financeApproveClaim, type FinanceClaim } from "@/lib/finance/finance-supabase-data"
import { AuthRequiredError } from "@/lib/finance/finance-supabase-data"
...
export default function ClaimDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleApprove = async () => {
    try {
      ...
      router.push(`/finance/payments?claimId=${encodeURIComponent(id)}`)
    } catch (err) {
