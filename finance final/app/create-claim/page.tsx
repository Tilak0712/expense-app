...
function CreateClaimInner() {
  ...
  const handleSubmit = async (isDraft: boolean = false) => {
    ...
    try {
      ...
      await createFinanceClaim(input)
  ...
  return (
    <FinanceLayout title={isEditMode ? 'Edit Expense Claim' : 'Create Expense Claim'}>
      <div className="flex flex-col p-6">
        <section className="flex-1 flex gap-6 overflow-hidden">
          {/* Left Panel: Form */}
          <div className="w-[45%] overflow-y-auto space-y-4">
            {/* OCR Upload Section */}
            <Card>
            ...
            <div className="flex-1 bg-muted/30 rounded-xl relative overflow-hidden border shadow-inner min-h-[600px]">
              ...
              {receiptImage ? (
                ...
                <div className="w-full h-full flex items-center justify-center p-8 text-center">
                  <div className="relative w-full max-w-md bg-card shadow-2xl rounded-lg p-8 flex flex-col gap-6 transform rotate-1 scale-[0.98]">
                    ...
                    <div className="border-y border-dashed border-border py-6 flex flex-col gap-4">
                      <div className="flex justify-between text-sm">
                        <span className="text-muted-foreground">Amount</span>
                        <span className="font-mono font-bold text-lg">{formatCurrency(previewAmount, formData.currency)}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                    ...
                    <div className="text-center">
                      <p className="text-[10px] text-muted-foreground uppercase tracking-[0.2em]">{formData.projectName}</p>
                    </div>
                  </div>
                </div>
              )}
...
export default function CreateClaimPage() {
  return (
    <Suspense
      fallback={
        <FinanceLayout title="Create Claim">
